...
parser.add_argument("--pretrained_model_path", type=str, default='./Model_zoo/SRNet_V2.pth', help='path log files')
parser.add_argument("--image_folder", type=str, default= './Measurements_Test/HyperspecI_V2/', help='path log files')
parser.add_argument("--save_folder", type=str, default= './Measurements_Test/Output_HyperspecI_V2/', help='path log files')
